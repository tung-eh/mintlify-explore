---
title: "What is Camelo?"
description: "Camelo is an employee scheduling software that helps shift-based workplaces manage their work schedules and people better."
---
...
- [Clock in and clock out](https://help.camelohq.com/articles/guide/time-attendance-tracking/intro-to-time-clock/clock-in-and-clock-out-of-shift/) from any device
...
You can [download and install Camelo](https://help.camelohq.com/articles/guide/getting-started/download-camelo/) in the [App Store](https://apps.apple.com/app/camelo-work-schedule-maker/id1577132228) or in the [Google Play Store](https://play.google.com/store/apps/details?id=com.camelo).

You can also use Camelo on desktop by visiting https://dashboard.camelohq.com/.

## ❓ How can I set up Camelo for my business?

Learn how to [create a business account](https://help.camelohq.com/articles/guide/getting-started/sign-up-for-a-business-account/) and [get started using a business account](https://help.camelohq.com/articles/guide/getting-started/quick-start-guide-for-business-owners-managers-admins/) in Camelo.
